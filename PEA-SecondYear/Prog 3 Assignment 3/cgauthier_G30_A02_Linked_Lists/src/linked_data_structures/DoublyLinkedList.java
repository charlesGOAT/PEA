...
public class DoublyLinkedList<E> implements Serializable
{
	 ...
	 *           
	 */
	private void switchPlayers(DoublyLinkedList<Player> players, int index1, int index2) {
		Player temp = players.getElementAt(index1);
		players.find(index1).setElement(players.getElementAt(index2));
		players.find(index2).setElement(temp);
